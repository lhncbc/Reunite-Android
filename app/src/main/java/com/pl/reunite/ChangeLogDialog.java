...
public class ChangeLogDialog {
    ...
    */
    ...
    private void parseReleaseTag(final StringBuilder changelogBuilder, final XmlPullParser resourceParser) throws XmlPullParserException, IOException {
        ...
        //Add versioncode if available
        if (resourceParser.getAttributeValue(null, "versioncode") != null) {
            changelogBuilder.append("Code: ").append("<span class='versioncode'>").append(resourceParser.getAttributeValue(null, "versioncode")).append("</span>");
        }
    ...
    public String getHTMLChangelog(final int resourceId, final Resources resources, final int version) {
    ...
    private void writeToFile(String data) {
        try {
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(mContext.openFileOutput("change_log_dis.html", Context.MODE_PRIVATE));
